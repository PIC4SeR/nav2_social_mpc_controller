                                  ...
                                  std::shared_ptr<tf2_ros::Buffer> tf)
{
  ...
  declare_parameter_if_not_declared(node, plugin_name_ + ".max_allowed_time_to_collision_up_to_carrot",
                                    rclcpp::ParameterValue(1.0));
  declare_parameter_if_not_declared(node, plugin_name_ + ".projection_lookahead_resolution",
  ...
  node->get_parameter(plugin_name_ + ".max_allowed_time_to_collision_up_to_carrot",
